...
public class KlantenDAO extends AbstractDAO {
	...
	//****************VOEG KLANT TOE****************//
	public void insert(String voornaam,String familienaam,String straat, String huisNr,String postcode,String gemeente,String gebruikersNaam,String paswoord){
	...
	public boolean bestaatKlant(String gebruikersnaam){
		...
		try(Connection connection=dataSource.getConnection();
				PreparedStatement statement=connection.prepareStatement(BESTAAT_KLANT);){
